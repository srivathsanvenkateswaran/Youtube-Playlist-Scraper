...
if __name__ == '__main__':
    playlist_scraper(playlist_id_from_link('https://www.youtube.com/playlist?list=PLzMcBGfZo4-nK0Pyubp7yIG0RdXp6zklu'))
    # Tech with Tim Blog playlist 
    playlist_scraper(playlist_id_from_link('https://www.youtube.com/playlist?list=PLQkwcJG4YTCQcFEPuYGuv54nYai_lwil_'))
    # Philipp Lackner Coroutines Playlist 